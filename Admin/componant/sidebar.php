<aside class="main-sidebar sidebar-dark-primary elevation-4" style="position: fixed; background-color:black">
  ...
  <a href="index.php?pages=admin&action=dashboard" class="brand-link">
    <img src="images/logoblack.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light" style="text-decoration: none;">LITECH</span>
  </a>
