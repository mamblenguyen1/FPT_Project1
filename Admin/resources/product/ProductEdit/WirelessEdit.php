        ...
        <div class="add-cate-form">
            <div class="card card-primary">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="category_id" value="<? echo $product->getInfoWireless($ProductId, 'category_id') ?>">
                    <input type="hidden" name="product_id" class="form-control"  value="<? echo $product->getInfoWireless($ProductId, 'product_id')?>">
                    <div class="card-body">
                        <!-- Tên điện thoại -->
                        <div class="form-group">
                            <label for="exampleInputEmail1">Tên thiết bị :  </label>
                            <input name="product_name" type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên. . ." value="<? echo $product->getInfoWireless($ProductId, 'product_name')?>">
                            <?
                        ...
                        <div class="form-group">
                            ...
                            <input name="product_title" type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên. . ." value="<? echo $product->getInfoWireless($ProductId, 'product_title')?>">
                            <?
                        ...
                        <div class="form-group">
                            ...
                            <input name="product_price" type="number" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên. . ." value="<? echo $product->getInfoWireless($ProductId, 'product_price')?>">
                            <?
                        ...
                        <div class="form-group">
                            ...
                            <input name="product_sale" type="number" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên. . ." value="<? echo $product->getInfoWireless($ProductId, 'product_sale')?>">
                            <?
                        ...
                        <div class="form-group">
                            ...
                            <input name="product_quantity" type="number" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên. . ." value="<? echo $product->getInfoWireless($ProductId, 'product_quantity')?>">
                            <?
                        ...
                        <div class="form-group">
                            ...
                            <input name="product_range" type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên. . ." value="<? echo $product->getInfoWireless($ProductId, 'product_range')?>">
                            <?
                        ...
                        <div class="form-group">
                            ...
                            <input name="product_port" type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên. . ." value="<? echo $product->getInfoWireless($ProductId, 'product_port')?>">
                            <?
                        ...
                        <div class="form-group">
                            ...
                            <input name="product_weight" type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên. . ." value="<? echo $product->getInfoWireless($ProductId, 'product_weight')?>">
                            <?
                        ...
                        <div class="form-group">
                            ...
                            <input name="product_included" type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên. . ." value="<? echo $product->getInfoWireless($ProductId, 'product_included')?>">
                            <?
                        ...
                        <div class="card-footer">
                            <button type="submit" name="EditWireless" class="btn btn-primary">Lưu danh mục</button>
                        </div>
                </form>
            </div>
        </div>
