...
if (isset($_POST['EditWired'])) {
    ...
    if (
        ...
        $product->Edit_Wired($product_name, $product_title, $product_price, $product_sale, $product_img, $product_quantity, $category_id, $type_id, 
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="product_quantity" type="number" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên. . ." value="<? echo $product->getInfoWired($ProductId, 'product_quantity')?>">
                            <?
                        ...
                        <div class="card-footer">
                            <button type="submit" name="EditWired" class="btn btn-primary">Lưu danh mục</button>
                        </div>
                </form>
            </div>
        </div>
