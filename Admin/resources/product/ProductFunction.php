...
class ProductFunction
{
    ...
    function add_Wireless($product_name, $product_title, $product_price, $product_sale, $product_img, $product_quantily,  $type_id, $product_range, $product_port, $product_weight, $product_included,  $product_capacity  , $product_charge_time, $product_use_time ,$user_created)
    {
        ...
        VALUES
        ('$product_name', '$product_title','$product_img' , $product_price, $product_sale, $product_quantily, 3 , $type_id, '$product_range', '$product_port', '$product_weight', '$product_included', $product_capacity  ,$product_charge_time,$product_use_time , $user_created,1 , 1 , 'WirelessDetail')";
        return $db->pdo_execute($sql);
    }
